  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto mt-8">
      ...
      <div className="mb-4">
        ...
        <input type="file" id="photo" name="photo" onChange={(e) => setPhoto(e.target.files[0])} className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
      </div>
      <div className="mb-4">
